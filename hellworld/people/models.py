...
class Participant(models.Model):
    ...
    team = models.ForeignKey('people.Team', related_name='members', on_delete=models.SET_NULL, null=True)
...
class MedicineSupply(models.Model):
    participant = models.ForeignKey('people.Participant', related_name='medicine_suppplies', on_delete=models.CASCADE)
